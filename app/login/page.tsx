      ...
      <div className="w-full max-w-md space-y-8 p-8 border border-border rounded-xl bg-card text-card-foreground shadow-sm">
        ...
        <div className="mt-8">
          <button
            ...
            disabled={isLoading}
            className="w-full flex justify-center items-center gap-3 py-3 px-4 border border-border rounded-md shadow-sm bg-background text-sm font-medium text-foreground hover:bg-muted focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            {isLoading ? (
