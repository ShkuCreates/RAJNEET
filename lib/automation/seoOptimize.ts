...
export async function seoOptimize(article: SEOData) {
  ...
  // STEP 1 — KEYWORD RESEARCH VIA GOOGLE TRENDS (FREE & CACHED)
  try {
    ...
    if (cached && !isExpired) {
      ...
      console.log("Using cached trends for:", mainKeyword);
    } else {
